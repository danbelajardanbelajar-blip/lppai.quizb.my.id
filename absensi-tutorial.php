...
<div class="card">
    <div class="card-header">📅 Absensi Tutorial</div>
    <div class="card-body">
        <div class="empty-state">
            ...
            <p style="text-align: center; color: #6b7280;">Halaman absensi tutorial ini masih dalam tahap pengembangan dan akan segera hadir.</p>
        </div>
    </div>
</div>
